 ...
 * @author jimi
 */
public class JMPCButtonSmall extends JPanel {
    ...
    public static JMPCButtonSmall create(String text, String resId){
        return new JMPCButtonSmall(text, resId);
    }
    public static JMPCButtonSmall create(String text, String resId, JMVec2 size){
        return new JMPCButtonSmall(text,resId,size);
    }
    
    public JMPCButtonSmall setFontColor(Color color){
        this.fontColor=color;
        this.refreshContent();
        return this;
    }
    public JMPCButtonSmall increaseFontSize(int inc){
        this.fontSize+=inc;
        this.refreshContent();
        return this;
    }
    public JMPCButtonSmall decreaseFontSize(int dec){
        this.fontSize-=dec;
        this.refreshContent();
        return this;
    }
    public JMPCButtonSmall setFont(String font){
        this.fontFamily=font;
        this.refreshContent();
        return this;
    }
    private JMPCButtonSmall setText(String text){
        this.text.setText(text);
        return this;
    }
    
    public JMPCButtonSmall(String text, String resId){
        this.setProp(text,resId, null);
    }
    public JMPCButtonSmall(String text, String resId, JMVec2 size){
    ...
    private void addListener(){
        this.uiListener=new MouseListener() {
            @Override
            public void mouseClicked(MouseEvent e) {
                JMPCButtonSmall.this.grabFocus();
            }

            @Override
            public void mousePressed(MouseEvent e) {
                //throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
                JMPCButtonSmall.this.clicked.setVisible(true);
                JMPCButtonSmall.this.normal.setVisible(false);
                JMPCButtonSmall.this.hover.setVisible(false);
            }

            @Override
            public void mouseReleased(MouseEvent e) {
                //throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
                JMPCButtonSmall.this.clicked.setVisible(false);
                JMPCButtonSmall.this.normal.setVisible(true);
                JMPCButtonSmall.this.hover.setVisible(false);
            }
            ...
            public void mouseEntered(MouseEvent e) {
                ...
                JMPCButtonSmall.this.normal.setVisible(false);
                JMPCButtonSmall.this.hover.setVisible(true);
            }
