 ...
 * @author jimi
 */
public class JMPCInputStringTFWeblafBtn extends JPanel implements JMFieldInterface{
    ...
    public static JMPCInputStringTFWeblafBtn create(String label,String prompt, int maxChar, int maxWidth, boolean horizontal){
        return new JMPCInputStringTFWeblafBtn("","","",label,prompt,maxChar,maxWidth,horizontal);
    }
    public static JMPCInputStringTFWeblafBtn create(String value, String text, String error, String label, String prompt, int maxChar, int maxWidth, boolean horizontal){
        return new JMPCInputStringTFWeblafBtn(value,text,error,label,prompt,maxChar,maxWidth,horizontal);
    }
    
    public JMPCInputStringTFWeblafBtn(String value, String text, String error, String label, String prompt, int maxChar, int maxWidth, boolean horizontal){
    ...
    private void setProp(String value, String text, String error, String label, String prompt, int maxChar, int maxWidth){
        ...
        txtPanel.add(this.text,BorderLayout.WEST);
        txtPanel.add(this.button,BorderLayout.EAST);
    ...
    public JMPCInputStringTFWeblafBtn setEditable(boolean editable){
    ...
    private void addListeners(){
        this.text.addKeyListener(new KeyListener() {
            ...
            @Override
            public void keyReleased(KeyEvent e) {
                /*if(JMPCInputStringTFWeblafBtn.this.editMode){
                    if(JMPCInputStringTFWeblafBtn.this.text.getText().equals("")){
                        JMPCInputStringTFWeblafBtn.this.hideError();
                    }
                    JMPCInputStringTFWeblafBtn.this.hideError();
                    if(JMPCInputStringTFWeblafBtn.this.dc==null)return;
                    JMPCInputStringTFWeblafBtn.this.dc.setValueString(JMPCInputStringTFWeblafBtn.this.text.getText());
                }*/
            }//EXIST
        });
        this.text.getDocument().addDocumentListener(new DocumentListener(){
            private void update(){
                ...
                //JMPCInputStringTFWeblafBtn.this.editingText=true;
                if(JMPCInputStringTFWeblafBtn.this.editingText){
                    if(JMPCInputStringTFWeblafBtn.this.editMode){
                        JMPCInputStringTFWeblafBtn.this.hideError();
                        if(JMPCInputStringTFWeblafBtn.this.dc==null)return;
                        JMPCInputStringTFWeblafBtn.this.dc.setValueString(JMPCInputStringTFWeblafBtn.this.text.getText(),false,false);
                    }
                }
            }
            @Override
        ...
        this.text.addFocusListener(new FocusListener() {
            ...
            public void focusGained(FocusEvent e) {
                if(JMPCInputStringTFWeblafBtn.this.editMode){
                    if(JMPCInputStringTFWeblafBtn.this.dc==null)return;
                    if(JMPCInputStringTFWeblafBtn.this.valueObject!=null)JMPCInputStringTFWeblafBtn.this.text.setText(JMPCInputStringTFWeblafBtn.this.value);
                    JMPCInputStringTFWeblafBtn.this.text.selectAll();
                    JMPCInputStringTFWeblafBtn.this.editingText=true;
                }
            }//EXIST
            ...
            public void focusLost(FocusEvent e) {
                if(JMPCInputStringTFWeblafBtn.this.editMode){
                    JMPCInputStringTFWeblafBtn.this.editingText=false;
                    if(JMPCInputStringTFWeblafBtn.this.text.getText().equals(""))JMPCInputStringTFWeblafBtn.this.hideError();
                    if(JMPCInputStringTFWeblafBtn.this.dc==null)return;
                    if(JMPCInputStringTFWeblafBtn.this.valueObject!=null)JMPCInputStringTFWeblafBtn.this.dc.setValueString(JMPCInputStringTFWeblafBtn.this.value,true,false);
                }
            }//EXIST
        });
    ...
    public void setEditMode(boolean editMode, JMRow currentRow, int column) {
        ...
        this.text.setEditable(false);
        this.button.setEnabled(this.editable && editMode);
    }
